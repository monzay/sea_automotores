...
function SelectLabel({
  ...
  return <SelectPrimitive.Label
    ...
    className={combinadorClases("text-muted-foreground px-2 py-1.5 text-xs", className)}
    {...props}
  />;
}
function SelectItem({
...
function SelectSeparator({
  ...
  return <SelectPrimitive.Separator
    ...
    className={combinadorClases("bg-border pointer-events-none -mx-1 my-1 h-px", className)}
    {...props}
  />;
}
