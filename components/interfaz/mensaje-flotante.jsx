...
const Toast = React.forwardRef(({ className, variant, ...props }, ref) => {
  return <ToastPrimitives.Root
    ref={ref}
    className={combinadorClases(toastVariants({ variant }), className)}
    {...props}
  />;
});
...
const ToastTitle = React.forwardRef(({ className, ...props }, ref) => <ToastPrimitives.Title
  ref={ref}
  className={combinadorClases("text-sm font-semibold", className)}
  {...props}
/>);
ToastTitle.displayName = ToastPrimitives.Title.displayName;
const ToastDescription = React.forwardRef(({ className, ...props }, ref) => <ToastPrimitives.Description
  ref={ref}
  className={combinadorClases("text-sm opacity-90", className)}
  {...props}
/>);
