...
function InputOTP({
  ...
  return <OTPInput
    data-slot="input-otp"
    containerClassName={combinadorClases(
      "flex items-center gap-2 has-disabled:opacity-50",
      containerClassName
    )}
    className={combinadorClases("disabled:cursor-not-allowed", className)}
    {...props}
  />;
}
function InputOTPGroup({ className, ...props }) {
  return <div
    ...
    className={combinadorClases("flex items-center", className)}
    {...props}
  />;
}
