...
function SeccionMetricas() {
  ...
  return <section id="studio" ref={sectionRef} className="relative py-24 lg:py-32 border-y border-foreground/10">
  ...
  >
    ...
    key={metric.label}
    className={`bg-background p-8 lg:p-12 transition-all duration-700 ${estaVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
