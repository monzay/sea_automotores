...
function SeccionInfraestructura() {
  ...
  return <section ref={sectionRef} className="relative py-24 lg:py-32 overflow-hidden">
    ...
    /* Left: Content */
          ...
          <div
    className={`transition-all duration-700 ${estaVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}
  >
    ...
    /* Right: Location list */
          ...
          <div
    className={`transition-all duration-700 delay-200 ${estaVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}
  >
